...
hold on
plot(out.x.Time',out.xd.Data(:,1)', 'LineWidth',1.8);
title('x');xlabel('Time'); 
legend('x', 'xd')
...
hold on
plot(out.x.Time',out.xd.Data(:,2)', 'LineWidth',1.8);
title('y');xlabel('Time'); 
legend('y', 'yd')
...
hold on
plot(out.x.Time',out.xd.Data(:,3)', 'LineWidth',1.8);
title('z');xlabel('Time'); 
legend('z', 'zd')
...
hold on
plot(out.x.Time',out.xd.Data(:,4)', 'LineWidth',1.8);
...
hold on
plot(out.x.Time',out.xd.Data(:,5)', 'LineWidth',1.8);
...
hold on
plot(out.x.Time',out.xd.Data(:,6)', 'LineWidth',1.8);
