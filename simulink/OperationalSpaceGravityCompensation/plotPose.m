...
hold on
plot(out.xd.Time',xD, 'LineWidth',1.8);
title('x');xlabel('Time'); 
legend('x', 'xd')
...
hold on
plot(out.xd.Time',yD, 'LineWidth',1.8);
title('y');xlabel('Time'); 
legend('y', 'yd')
...
hold on
plot(out.xd.Time',zD, 'LineWidth',1.8);
title('z');xlabel('Time'); 
legend('z', 'zd')
...
hold on
plot(out.xd.Time',phiD, 'LineWidth',1.8);
...
hold on
plot(out.xd.Time',thetaD, 'LineWidth',1.8);
...
hold on
plot(out.xd.Time',psiD, 'LineWidth',1.8);
